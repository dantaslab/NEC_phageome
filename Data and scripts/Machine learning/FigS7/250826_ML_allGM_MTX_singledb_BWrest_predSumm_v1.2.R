...
all.pred.long = filter(all.pred.long, DataSet == "BacRest" & !is.na(Performance_Measure_Value))
...
p_rf_pred_line_vir
ggsave("250826_lineVir_Pred_allTaxa_MTX_BW_singledb_DBO_v1.2.1_rest.pdf", p_rf_pred_line_vir , width=8, height=7)
...
p_rf_pred_line_vir
ggsave("250826_lineVir_Pred_allTaxa_MTX_BW_singledb_DBO_v1.2.2_rest.pdf", p_rf_pred_line_vir , width=8, height=4.8)
