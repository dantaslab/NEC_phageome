...
library(readxl)
library(sjmisc)
setwd('~/Google Drive/WashU/Phageome/NEC/Manuscript/Figures_drop/Figure 3/Fig3A_extension/Fig3A_eachDBO/MaAsLin2_Phage_HostGenus_RA')
```
Getting data
```{r}
## RA of phages infecting bacteria at genus level
X_all <- read.csv('Phage_relAbundance_genus_all.csv',head = TRUE) 
...
X_late = filter(X_all, Days_before_NEC_onset<=6 & Days_before_NEC_onset>=5 & NEC_onset2=="Early")
...
fit_data = Maaslin2(
    ...
    normalization = "NONE",
    transform = "LOG",
    output = "250416_Phage_HostGenus_drop_LM_LOG_0.01_early_DBO5_6", 
