...
# ImpVar.df        = read.csv('241128_ML_sallTaxa_MAX_VarImpTest2_early_v1.2.csv', header = T)
...
early.keymetadata1 = c('Calcium_gluconate_recent', 'Chlorathiazide_recent', 'Iron_recent', 'milk_cumulative', 'Abx_cumulative', 
                       'ANTIM_cumulative', 'GA_birth', 'Lasix_recent', 'Sex', 'Recent_3rd_gen_cephalosporin', 'route')
early.keymetadata2 = c('Calcium_gluconate_recent', 'Chlorathiazide_recent', 'Iron_recent', 'milk_cumulative', 'Abx_cumulative', 
                       'ANTIM_cumulative', 'GA_birth', 'Lasix_recent', 'Sex', 'Recent_3rd_gen_cephalosporin', 'route', 
                       'Birthweight', 'Insulin_recent')
...
write.table(cbind('Days_before_onset','Control.Control', 'Control.Case', 'Case.Control', 'Case.Case', 
            ...
            "250418_ML_9ImpVir_meta_early_pred_v1.2.csv", 
...
write.table(cbind('Days_before_onset','DataSet', 'Taxa', 'Feature', 'Feature.MeanImp', 'Feature.SDImp', 'Feature.NULLMeanImp', 'Feature.NULLSDImp'), 
            "250418_ML_9ImpVir_meta_early_VarImpSumm_v1.2.csv", 
            col.names = FALSE, row.names = FALSE, sep = ",")
...
for (DBO in 0:8){
  ...
  fs.virtaxa.9imp    = c('Shigella_vir', 'Enterobacter_vir', 'Salmonella_vir', 'Klebsiella_vir', 'Klebsiella_grimontii_vir', 
                         'Atlantibacter_vir', 'Dickeya_vir', 'Serratia_vir', 'Enterococcus_faecalis_vir') # 9 selected viral features
  fs.allmeta.9impvir        = c(fs.virtaxa.9imp, colnames(meta.df))
  fs.impmeta_all1.9impvir   = c(fs.virtaxa.9imp, all.keymetadata1)
  fs.impmeta_all2.9impvir   = c(fs.virtaxa.9imp, all.keymetadata2)
  fs.impmeta_early1.9impvir = c(fs.virtaxa.9imp, early.keymetadata1)
  fs.impmeta_early2.9impvir = c(fs.virtaxa.9imp, early.keymetadata2)
  ...
  virtaxa.9imp           = GM.caret[ , colnames(GM.caret) %in% c(fs.virtaxa.9imp,'NEC_status')]
  allmeta.9impvir        = GM.caret[ , colnames(GM.caret) %in% fs.allmeta.9impvir] 
  impmeta_all1.9impvir   = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_all1.9impvir,'NEC_status')] 
  impmeta_all2.9impvir   = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_all2.9impvir,'NEC_status')] 
  impmeta_early1.9impvir = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_early1.9impvir,'NEC_status')] 
  impmeta_early2.9impvir = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_early2.9impvir,'NEC_status')] 
  ...
  imp_9vir               <- createSubsets(virtaxa.9imp, all.nullvars, Taxa=virtaxa.9imp)
  allmeta_9impvir        <- createSubsets(allmeta.9impvir, all.nullvars, Taxa=allmeta.9impvir)
  impmeta_all1_9impvir   <- createSubsets(impmeta_all1.9impvir, all.nullvars, Taxa=impmeta_all1.9impvir)
  impmeta_all2_9impvir   <- createSubsets(impmeta_all2.9impvir, all.nullvars, Taxa=impmeta_all2.9impvir)
  impmeta_early1_9impvir <- createSubsets(impmeta_early1.9impvir, all.nullvars, Taxa=impmeta_early1.9impvir)
  impmeta_early2_9impvir <- createSubsets(impmeta_early2.9impvir, all.nullvars, Taxa=impmeta_early2.9impvir)
  ...
  #                                   varsnot2norm, FALSE)
  rf.imp9vir                <- train_rf_models(imp_9vir$Base, cv10, 'imp9Vir', 
                                               varsnot2norm, FALSE)
  rf.imp9vir_allmeta        <- train_rf_models(allmeta_9impvir$Base, cv10, 'imp9Vir_Allmeta', 
                                               varsnot2norm, FALSE)
  rf.imp9vir_impmeta.all1   <- train_rf_models(impmeta_all1_9impvir$Base, cv10, 'imp9Vir_impmeta.all1', 
                                               varsnot2norm, FALSE)
  rf.imp9vir_impmeta.all2   <- train_rf_models(impmeta_all2_9impvir$Base, cv10, 'imp9Vir_impmeta.all2', 
                                               varsnot2norm, FALSE)
  rf.imp9vir_impmeta.early1 <- train_rf_models(impmeta_early1_9impvir$Base, cv10, 'imp9Vir_impmeta.early1', 
                                               varsnot2norm, FALSE)
  rf.imp9vir_impmeta.early2 <- train_rf_models(impmeta_early2_9impvir$Base, cv10, 'imp9Vir_impmeta.early2', 
                                               varsnot2norm, FALSE)
  
  
  all.pred.Val <- rbind(rf.imp9vir$Pred.Results.Val,
                        rf.imp9vir_allmeta$Pred.Results.Val,
                        rf.imp9vir_impmeta.all1$Pred.Results.Val,
                        rf.imp9vir_impmeta.all2$Pred.Results.Val,
                        rf.imp9vir_impmeta.early1$Pred.Results.Val,
                        rf.imp9vir_impmeta.early2$Pred.Results.Val)
  
  # rf.all_Virtaxa$Var.Importance$Dataset = "virtaxa"
  # rf.imp_Virtaxa$Var.Importance$Dataset = "impvirtaxa"
  # rf.imp9vir$Var.Importance$Dataset = "8VirTaxa"
  # rf.imp9vir_allmeta$Var.Importance$Dataset = "allmaaslinBIN"
  ...
  # 
  all.VarImp.list <- list(rf.imp9vir$Var.Importance,
                          rf.imp9vir_allmeta$Var.Importance,
                          rf.imp9vir_impmeta.all1$Var.Importance,
                          rf.imp9vir_impmeta.all2$Var.Importance,
                          rf.imp9vir_impmeta.early1$Var.Importance,
                          rf.imp9vir_impmeta.early2$Var.Importance)
  ...
  #                                         varsnot2norm, TRUE)
  rfN.imp9vir                <- train_rf_models(imp_9vir$Base, cv10, 'imp9Vir', 
                                                varsnot2norm, TRUE)
  rfN.imp9vir_allmeta        <- train_rf_models(allmeta_9impvir$Base, cv10, 'imp9Vir_Allmeta', 
                                                varsnot2norm, TRUE)
  rfN.imp9vir_impmeta.all1   <- train_rf_models(impmeta_all1_9impvir$Base, cv10, 'imp9Vir_impmeta.all1', 
                                                varsnot2norm, TRUE)
  rfN.imp9vir_impmeta.all2   <- train_rf_models(impmeta_all2_9impvir$Base, cv10, 'imp9Vir_impmeta.all2', 
                                                varsnot2norm, TRUE)
  rfN.imp9vir_impmeta.early1 <- train_rf_models(impmeta_early1_9impvir$Base, cv10, 'imp9Vir_impmeta.early1', 
                                                varsnot2norm, TRUE)
  rfN.imp9vir_impmeta.early2 <- train_rf_models(impmeta_early2_9impvir$Base, cv10, 'imp9Vir_impmeta.early2', 
                                                varsnot2norm, TRUE)
  
  NULL.all.pred.Val <- rbind(rfN.imp9vir$Pred.Results.Val,
                             rfN.imp9vir_allmeta$Pred.Results.Val,
                             rfN.imp9vir_impmeta.all1$Pred.Results.Val,
                             rfN.imp9vir_impmeta.all2$Pred.Results.Val,
                             rfN.imp9vir_impmeta.early1$Pred.Results.Val,
                             rfN.imp9vir_impmeta.early2$Pred.Results.Val)
  ...
  NULL.all.VarImp.list <- list(rfN.imp9vir$Var.Importance,
                               rfN.imp9vir_allmeta$Var.Importance,
                               rfN.imp9vir_impmeta.all1$Var.Importance,
                               rfN.imp9vir_impmeta.all2$Var.Importance,
                               rfN.imp9vir_impmeta.early1$Var.Importance,
                               rfN.imp9vir_impmeta.early2$Var.Importance)
  ...
  #             paste("250418_ML_9ImpVir_meta_early_VarImpCombined_DBO", DBO, "_v1.2.csv", sep = ""),
  ...
  write.table(c(DBO,varimp.tests), 
              paste("250418_ML_9ImpVir_meta_early_VarImpTest_DBO", DBO, "_v1.2.csv", sep = ""),
              append = FALSE, col.names = TRUE, row.names = FALSE, sep = ",")
}
