...
all.pred.Val2 <- read.csv('241127_ML_allTaxa_MTX_singledb_pred_v1.2.csv', header = T)
...
p_rf_pred_box <- ggplot(all.pred.long, aes(x=DataSet, y=Performance_Measure_Value, fill=DataSet))+
  ...
  geom_hline(data=mu, aes(yintercept=grp.mean),
             ...
             linetype = 2) 
p_rf_pred_box
ggsave("241127_box_Pred_allTaxa_MTX_singledb_DBO>0_v1.2.pdf", p_rf_pred_box , width=10, height=3)
...
p_rf_pred_line 
ggsave("241127_line_Pred_allTaxa_MTX_singledb_DBO_v1.2.pdf", p_rf_pred_line , width=12, height=3)
...
p_rf_pred_line_vir <- ggplot(all.pred.long.vir, aes(x=Days_before_onset, y=Performance_Measure_Value, 
  ...
  scale_x_reverse(limits = c(8, 0), breaks=c(0:8))
p_rf_pred_line_vir
ggsave("241127_lineVir_Pred_allTaxa_MTX_singledb_DBO_v1.2.pdf", p_rf_pred_line_vir , width=12, height=3)
...
ggheatmap_sig
ggsave("241127_heatmap_Pred_allTaxa_MTX_singledb_DBO_v1.2.pdf", ggheatmap_sig, width=12, height=3)
...
p_rf_pred_box
ggsave("241127_box_Pred_allTaxa_MTX_singledb_DBO>0_group4_v1.2.pdf", p_rf_pred_box , width=10, height=5)
