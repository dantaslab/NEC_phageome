...
dataset_imp_Bacrestirep  = merge(dataset_all_resistome,dataset_all_iRep,by="row.names")
rownames(dataset_imp_Bacrestirep) = dataset_imp_Bacrestirep$Row.names
dataset_imp_Bacrestirep$Row.names = NULL
...
dataset_imp_BacrestirepMAX = merge(dataset_imp_Bacrestirep,dataset_all_MAX,by="row.names")
...
dataset_all  = merge(dataset_all2,dataset_imp_BacrestirepMAX,by="Row.names")
...
ImpVar.df    = read.csv('Input/241129_ML_sallTaxa_MAX_VarImpTest2_late_rest_v1.2re.csv', header = T)
# ImpVar.all   = unique(ImpVar.df$Feature)
ImpVar.rest  = unique(ImpVar.df$Feature[ImpVar.df$DataSet=="BacRest"])
# Boruta.df  = read.csv('~/Google Drive/WashU/Phageome/NEC/Manuscript/Figures_drop/Figure 4_ML/Boruta/AddOn_virome/Select_Boruta/250415_NEC_Boruta_late_rest_sum.csv', header = T)
Boruta.df    = read.csv('Input/250415_NEC_Boruta_late_rest_sum.csv', header = T)
Boruta.rest  = unique(Boruta.df$Feature[Boruta.df$Dataset=="BacRest"])
# Maaslin.df = read.csv('~/Google Drive/WashU/Phageome/NEC/Manuscript/Figures_drop/Figure 3/Fig3A_extension/Fig3A_eachDBO/250416_maaslin2_resistome_sig_features_late.csv', header = T)
Maaslin.df   = read.csv('Input/250416_maaslin2_resistome_sig_features_late.csv', header = T)
Maaslin.rest = paste(unique(Maaslin.df$feature) ,"rest",sep="_")
...
write.table(cbind('Days_before_onset','Control.Control', 'Control.Case', 'Case.Control', 'Case.Case', 
            ...
            "250417_ML_ImpVIr_late_rest_pred_v1.2.csv", 
...
write.table(cbind('Days_before_onset','DataSet', 'Taxa', 'Feature', 'Feature.MeanImp', 'Feature.SDImp', 'Feature.NULLMeanImp', 'Feature.NULLSDImp'), 
            "250417_ML_ImpVIr_late_rest_VarImpSumm_v1.2.csv", 
            col.names = FALSE, row.names = FALSE, sep = ",")
...
for (DBO in 0:14){
  ...
  fs.bacrest.imp     = ImpVar.rest
  fs.bacrest.boruta  = Boruta.rest
  fs.bacrest.maaslin = Maaslin.rest
  fs.all.impvari1    = c('COLISTIN_rest', 'TRICLOSAN_rest', 'X0.WP_000506490_1.1.1.fabI.fabI.mutation.2...enoyl._acyl.carrier.protein__reductase_FabI_rest', 'LINCOSAMIDE.STREPTOGRAMIN_rest', 'X0.WP_000888203_1.1.1.oqxR.oqxR.mutation.2...Rrf2_family_transcriptional_regulator_OqxR_rest', 'EFFLUX_rest', 'X29342129.WP_002356022_1.1.1.yybT.yybT.mutation.2...cyclic_dinucleotide_phosphodiesterase_YybT_rest', 'LIPOPEPTIDE_rest') #8
  fs.all.impvari2    = c('COLISTIN_rest', 'TETRACYCLINE_rest', 'TRICLOSAN_rest', 'X0.WP_000506490_1.1.1.fabI.fabI.mutation.2...enoyl._acyl.carrier.protein__reductase_FabI_rest', 'LINCOSAMIDE.STREPTOGRAMIN_rest', 'X0.WP_000888203_1.1.1.oqxR.oqxR.mutation.2...Rrf2_family_transcriptional_regulator_OqxR_rest', 'EFFLUX_rest', 'X29342129.WP_002356022_1.1.1.yybT.yybT.mutation.2...cyclic_dinucleotide_phosphodiesterase_YybT_rest', 'LIPOPEPTIDE_rest') #9
  fs.all.impvari3    = c('COLISTIN_rest', 'TETRACYCLINE_rest', 'TRICLOSAN_rest', 'X0.WP_000506490_1.1.1.fabI.fabI.mutation.2...enoyl._acyl.carrier.protein__reductase_FabI_rest', 'EFFLUX_rest', 'LINCOSAMIDE.STREPTOGRAMIN_rest', 'LIPOPEPTIDE_rest', 'X0.WP_004141771_1.1.1.ompK35.ompK35.mutation.2...outer_membrane_porin_OmpK35_rest', 'X1011600567.WP_002389492_1.1.1.gshF.gshF.mutation.2...bifunctional_glutamate..cysteine_ligase_glutathione_synthetase_GshF_rest', 'X1028105873.WP_063860896_1.1.1.blaOKP.A.1.blaOKP.A.hydrolase.2.BETA.LACTAM.BETA.LACTAM.class_A_broad.spectrum_beta.lactamase_OKP.A.1_rest', 'X0.WP_000888203_1.1.1.oqxR.oqxR.mutation.2...Rrf2_family_transcriptional_regulator_OqxR_rest', 'X29342129.WP_002356022_1.1.1.yybT.yybT.mutation.2...cyclic_dinucleotide_phosphodiesterase_YybT_rest', 'X29344842.WP_002355137_1.1.1.liaR.liaR.mutation.2...response_regulator_transcription_factor_LiaR_rest', 'X29344843.WP_002365182_1.1.1.liaS.liaS.mutation.2...sensor_histidine_kinase_LiaS_rest', 'X29344844.WP_002381168_1.1.1.liaF.liaF.mutation.2...three.component_signaling_pathway_regulator_LiaF_rest', 'X327534217.WP_002413481_1.1.1.cls.cls.mutation.2...cardiolipin_synthase_Cls_rest', 'X488293845.WP_002365053_1.1.1.lsa.A..lsa.A..target_protection.2.LINCOSAMIDE_STREPTOGRAMIN.LINCOSAMIDE_STREPTOGRAMIN.ABC.F_type_ribosomal_protection_protein_Lsa.A._rest', 'X488300672.WP_002371880_1.1.1.parC.parC.mutation.2...DNA_topoisomerase_IV_subunit_A_ParC_rest', 'X489000713.WP_002911375_1.1.1.mgrB.mgrB.mutation.2...PhoP_PhoQ_regulator_MgrB_rest') #19 
  fs.all.impvari4    = c('EFFLUX_rest', 'COLISTIN_rest', 'X29344842.WP_002355137_1.1.1.liaR.liaR.mutation.2...response_regulator_transcription_factor_LiaR_rest') #3
  fs.all.impvari5    = c('EFFLUX_rest', 'COLISTIN_rest') #2
  
  bacrest.all     = GM.caret[ , colnames(GM.caret) %in% c(fs.bacrest.all, "NEC_status")] 
  bacrest.imp     = GM.caret[ , colnames(GM.caret) %in% c(fs.bacrest.imp, "NEC_status")] 
  bacrest.boruta  = GM.caret[ , colnames(GM.caret) %in% c(fs.bacrest.boruta, "NEC_status")] 
  bacrest.maaslin = GM.caret[ , colnames(GM.caret) %in% c(fs.bacrest.maaslin, "NEC_status")] 
  ...
  # Create Data Subsets
  #  Main Text models:
  all.bacrest     <- createSubsets(bacrest.all, all.nullvars, Taxa=bacrest.all)
  imp.bacrest     <- createSubsets(bacrest.imp, all.nullvars, Taxa=bacrest.imp)
  boruta.bacrest  <- createSubsets(bacrest.boruta, all.nullvars, Taxa=bacrest.boruta)
  maaslin.bacrest <- createSubsets(bacrest.maaslin, all.nullvars, Taxa=bacrest.maaslin)
  ...
  rf.all_Bacrest     <- train_rf_models(all.bacrest$Base, cv10, 'BacRest', 
                                        varsnot2norm, FALSE)
  rf.imp_Bacrest     <- train_rf_models(imp.bacrest$Base, cv10, 'impBacRest', 
                                        varsnot2norm, FALSE)
  rf.boruta_Bacrest  <- train_rf_models(boruta.bacrest$Base, cv10, 'BorutaBacRest', 
                                        varsnot2norm, FALSE)
  rf.maaslin_Bacrest <- train_rf_models(maaslin.bacrest$Base, cv10, 'MaaslinBacRest', 
                                        varsnot2norm, FALSE)
  rf.imp_Allvari1    <- train_rf_models(imp.allvari1$Base, cv10, 'impRestVari8', 
                                        varsnot2norm, FALSE)
  rf.imp_Allvari2    <- train_rf_models(imp.allvari2$Base, cv10, 'impRestVari9', 
                                        varsnot2norm, FALSE)
  rf.imp_Allvari3    <- train_rf_models(imp.allvari3$Base, cv10, 'impRestVari19', 
                                        varsnot2norm, FALSE)
  rf.imp_Allvari4    <- train_rf_models(imp.allvari4$Base, cv10, 'impRestVari3', 
                                        varsnot2norm, FALSE)
  rf.imp_Allvari5    <- train_rf_models(imp.allvari5$Base, cv10, 'impRestVari2', 
                                        varsnot2norm, FALSE)
  ...
  all.pred.Val <- rbind(rf.all_Bacrest$Pred.Results.Val,
                        rf.imp_Bacrest$Pred.Results.Val,
                        rf.boruta_Bacrest$Pred.Results.Val,
                        rf.maaslin_Bacrest$Pred.Results.Val,
  ...
  rf.all_Bacrest$Var.Importance$Dataset     = "bacrest"
  rf.imp_Bacrest$Var.Importance$Dataset     = "impbacrest"
  rf.boruta_Bacrest$Var.Importance$Dataset  = "imprestboruta"
  rf.maaslin_Bacrest$Var.Importance$Dataset = "imprestmaaslin"
  rf.imp_Allvari1$Var.Importance$Dataset    = "imprestvari8"
  rf.imp_Allvari2$Var.Importance$Dataset    = "imprestvari9"
  rf.imp_Allvari3$Var.Importance$Dataset    = "imprestvari19"
  rf.imp_Allvari4$Var.Importance$Dataset    = "imprestvari3"
  rf.imp_Allvari5$Var.Importance$Dataset    = "impRestVari2"
  
  all.VarImp.list <- list(rf.all_Bacrest$Var.Importance,
                          rf.imp_Bacrest$Var.Importance,
                          rf.boruta_Bacrest$Var.Importance,
                          rf.maaslin_Bacrest$Var.Importance,
  ...
  rfN.all_Bacrest     <- train_rf_models(all.bacrest$Base, cv10, 'BacRest', 
                                         varsnot2norm, TRUE)
  rfN.imp_Bacrest     <- train_rf_models(imp.bacrest$Base, cv10, 'impBacRest', 
                                         varsnot2norm, TRUE)
  rfN.boruta_Bacrest  <- train_rf_models(boruta.bacrest$Base, cv10, 'BorutaBacRest', 
                                         varsnot2norm, TRUE)
  rfN.maaslin_Bacrest <- train_rf_models(maaslin.bacrest$Base, cv10, 'MaaslinBacRest', 
                                         varsnot2norm, TRUE)
  rfN.imp_Allvari1    <- train_rf_models(imp.allvari1$Base, cv10, 'impRestVari8', 
                                         varsnot2norm, TRUE)
  rfN.imp_Allvari2    <- train_rf_models(imp.allvari2$Base, cv10, 'impRestVari9', 
                                         varsnot2norm, TRUE)
  rfN.imp_Allvari3    <- train_rf_models(imp.allvari3$Base, cv10, 'impRestVari19', 
                                         varsnot2norm, TRUE)
  rfN.imp_Allvari4    <- train_rf_models(imp.allvari4$Base, cv10, 'impRestVari3', 
                                         varsnot2norm, TRUE)
  rfN.imp_Allvari5    <- train_rf_models(imp.allvari5$Base, cv10, 'impRestVari2', 
                                         varsnot2norm, TRUE)
  ...
  NULL.all.pred.Val <- rbind(rfN.all_Bacrest$Pred.Results.Val,
                        rfN.imp_Bacrest$Pred.Results.Val,
                        rfN.boruta_Bacrest$Pred.Results.Val,
                        rfN.maaslin_Bacrest$Pred.Results.Val,
  ...
  rfN.all_Bacrest$Var.Importance$Dataset     = "bacrest"
  rfN.imp_Bacrest$Var.Importance$Dataset     = "impbacrest"
  rfN.boruta_Bacrest$Var.Importance$Dataset  = "imprestboruta"
  rfN.maaslin_Bacrest$Var.Importance$Dataset = "imprestmaaslin"
  rfN.imp_Allvari1$Var.Importance$Dataset    = "imprestvari8"
  rfN.imp_Allvari2$Var.Importance$Dataset    = "imprestvari9"
  rfN.imp_Allvari3$Var.Importance$Dataset    = "imprestvari19"
  rfN.imp_Allvari4$Var.Importance$Dataset    = "imprestvari3"
  rfN.imp_Allvari5$Var.Importance$Dataset    = "impRestVari2"
  
  NULL.all.VarImp.list <- list(rfN.all_Bacrest$Var.Importance,
                               rfN.imp_Bacrest$Var.Importance,
                               rfN.boruta_Bacrest$Var.Importance,
                               rfN.maaslin_Bacrest$Var.Importance,
  ...
  all.pred.Val2 <- all.pred.Val %>% 
    ...
    mutate(Taxa = ifelse(is.na(Taxa), 'all BacRest', 
                         'Plus others'))
  ...
  # pvar_bacrest <- plotVarImp(VarImp.summ, 'plus BacRest', varimp.labels)
  # pvar_impbacrest <- plotVarImp(VarImp.summ, 'plus impBacRest', varimp.labels)
  # pvar_feature <- plotVarImp(VarImp.summ, 'plus impRestVari', varimp.labels)
  # pvarimp_main <- ggarrange(pvar_all, pvar_bactaxa, 
  #                           pvar_bacrest, pvar_impbacrest, nrow=2)
  ...
  all.VarImp3 <- subset(all.VarImp2, Taxa == 'all BacRest')
  all.VarImp3$Group <- 'Empirical'
  
  all.VarImp_NULL3 <- subset(all.VarImp_NULL2, Taxa == 'all BacRest')
  ...
  #             paste("250417_ML_ImpVIr_late_rest_VarImpCombined_DBO", DBO, "_v1.2.csv", sep = ""),
  ...
  write.table(c(DBO,varimp.tests), 
              paste("250417_ML_ImpVIr_late_rest_VarImpTest_DBO", DBO, "_v1.2.csv", sep = ""),
              append = FALSE, col.names = TRUE, row.names = FALSE, sep = ",")
}
