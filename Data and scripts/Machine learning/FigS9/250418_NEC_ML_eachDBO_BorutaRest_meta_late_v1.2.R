...
dataset_imp8vir_allmetairep  = merge(dataset_all_resistome,dataset_all_iRep,by="row.names")
rownames(dataset_imp8vir_allmetairep) = dataset_imp8vir_allmetairep$Row.names
dataset_imp8vir_allmetairep$Row.names = NULL
...
dataset_imp8vir_allmetairepMAX = merge(dataset_imp8vir_allmetairep,dataset_all_MAX,by="row.names")
...
dataset_all  = merge(dataset_all2,dataset_imp8vir_allmetairepMAX,by="Row.names")
...
# ImpVar.df        = read.csv('241128_ML_sallTaxa_MAX_VarImpTest2_late_v1.2.csv', header = T)
...
all.keymetadata1 = c('Calcium_gluconate_recent', 'route', 'Sex', 'ANTIM_cumulative', 'Iron_recent', 'milk_cumulative', 
                     'Abx_cumulative', 'Caffeine_recent', 'formula_cumulative', 'GA_birth', 'Birthweight', 'Lasix_recent', 
                     'Multi_vitamin_with_iron_recent', 'Other_ANTIM_recent')
all.keymetadata2 = c('Calcium_gluconate_recent', 'route', 'Sex', 'ANTIM_cumulative', 'Iron_recent', 'milk_cumulative', 
                     'Abx_cumulative', 'Caffeine_recent', 'formula_cumulative', 'GA_birth', 'Birthweight', 'Lasix_recent', 
                     'Multi_vitamin_with_iron_recent', 'Other_ANTIM_recent', 
                     'Chlorathiazide_recent', 'Hydrocortisone_recent', 'Insulin_recent', 'Morphine_recent')
late.keymetadata1 = c('Chlorathiazide_recent', 'milk_cumulative', 'Hydrocortisone_recent', 'multiple', 'route')
late.keymetadata2 = c('Chlorathiazide_recent', 'milk_cumulative', 'Hydrocortisone_recent', 'multiple', 'route',
                      'Recent_aminoglycoside', 'Cholecalciferol_recent', 'Recent_lincosamide', 'Multi_vitamin_with_iron_recent', 'Sex')
...
write.table(cbind('Days_before_onset','Control.Control', 'Control.Case', 'Case.Control', 'Case.Case', 
            ...
            "250418_ML_BorutaRest_meta_late_pred_v1.2.csv", 
...
write.table(cbind('Days_before_onset','DataSet', 'Taxa', 'Feature', 'Feature.MeanImp', 'Feature.SDImp', 'Feature.NULLMeanImp', 'Feature.NULLSDImp'), 
            "250418_ML_BorutaRest_meta_late_VarImpSumm_v1.2.csv", 
            col.names = FALSE, row.names = FALSE, sep = ",")
...
for (DBO in 0:8){
  ...
  GM.caret <- merge(GM.caret, meta.caret, by='row.names')
  rownames(GM.caret) <- GM.caret$Row.names
  GM.caret$Row.names <- NULL
  
  meta.df = GM.caret[,c((ncol(GM.caret)-ncol(meta.caret)+3):ncol(GM.caret))]
  meta.df$Days_before_NEC_onset = NULL
  ...
  fs.allmeta.borutabacrest       = c(fs.bacrest.boruta, colnames(meta.df))
  fs.impmeta_all1.borutabacrest  = c(fs.bacrest.boruta, all.keymetadata1)
  fs.impmeta_all2.borutabacrest  = c(fs.bacrest.boruta, all.keymetadata2)
  fs.impmeta_late1.borutabacrest = c(fs.bacrest.boruta, late.keymetadata1)
  fs.impmeta_late2.borutabacrest = c(fs.bacrest.boruta, late.keymetadata2)
  ...
  allmeta.borutabacrest       = GM.caret[ , colnames(GM.caret) %in% fs.allmeta.borutabacrest] 
  impmeta_all1.borutabacrest  = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_all1.borutabacrest,'NEC_status')] 
  impmeta_all2.borutabacrest  = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_all2.borutabacrest,'NEC_status')] 
  impmeta_late1.borutabacrest = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_late1.borutabacrest,'NEC_status')] 
  impmeta_late2.borutabacrest = GM.caret[ , colnames(GM.caret) %in% c(fs.impmeta_late2.borutabacrest,'NEC_status')] 
  ...
  boruta_rest                 <- createSubsets(bacrest.boruta, all.nullvars, Taxa=bacrest.boruta)
  allmeta_borutabacrest       <- createSubsets(allmeta.borutabacrest, all.nullvars, Taxa=allmeta.borutabacrest)
  impmeta_all1_borutabacrest  <- createSubsets(impmeta_all1.borutabacrest, all.nullvars, Taxa=impmeta_all1.borutabacrest)
  impmeta_all2_borutabacrest  <- createSubsets(impmeta_all2.borutabacrest, all.nullvars, Taxa=impmeta_all2.borutabacrest)
  impmeta_late1_borutabacrest <- createSubsets(impmeta_late1.borutabacrest, all.nullvars, Taxa=impmeta_late1.borutabacrest)
  impmeta_late2_borutabacrest <- createSubsets(impmeta_late2.borutabacrest, all.nullvars, Taxa=impmeta_late2.borutabacrest)
  ...
  #                                   varsnot2norm, FALSE)
  rf.borutarest                <- train_rf_models(boruta_rest$Base, cv10, 'borutaRest', 
                                               varsnot2norm, FALSE)
  rf.borutarest_allmeta        <- train_rf_models(allmeta_borutabacrest$Base, cv10, 'borutaRest_Allmeta', 
                                               varsnot2norm, FALSE)
  rf.borutarest_impmeta.all1   <- train_rf_models(impmeta_all1_borutabacrest$Base, cv10, 'borutaRest_impmeta.all1', 
                                               varsnot2norm, FALSE)
  rf.borutarest_impmeta.all2   <- train_rf_models(impmeta_all2_borutabacrest$Base, cv10, 'borutaRest_impmeta.all2', 
                                               varsnot2norm, FALSE)
  rf.borutarest_impmeta.late1 <- train_rf_models(impmeta_late1_borutabacrest$Base, cv10, 'borutaRest_impmeta.late1', 
                                               varsnot2norm, FALSE)
  rf.borutarest_impmeta.late2 <- train_rf_models(impmeta_late2_borutabacrest$Base, cv10, 'borutaRest_impmeta.late2', 
                                               varsnot2norm, FALSE)
  
  
  all.pred.Val <- rbind(rf.borutarest$Pred.Results.Val,
                        rf.borutarest_allmeta$Pred.Results.Val,
                        rf.borutarest_impmeta.all1$Pred.Results.Val,
                        rf.borutarest_impmeta.all2$Pred.Results.Val,
                        rf.borutarest_impmeta.late1$Pred.Results.Val,
                        rf.borutarest_impmeta.late2$Pred.Results.Val)
  
  # rf.all_Virtaxa$Var.Importance$Dataset = "virtaxa"
  # rf.imp_Virtaxa$Var.Importance$Dataset = "impvirtaxa"
  # rf.borutarest$Var.Importance$Dataset = "8VirTaxa"
  # rf.borutarest_allmeta$Var.Importance$Dataset = "allmaaslinBIN"
  # rf.imp8vir_impmeta$Var.Importance$Dataset = "allmaaslinLM"
  # rf.dbo8_MaaslinBIN$Var.Importance$Dataset = "dbo8maaslinBIN"
  # rf.dbo8_MaaslinLM$Var.Importance$Dataset = "dbo8maaslinLM"
  # 
  all.VarImp.list <- list(rf.borutarest$Var.Importance,
                          rf.borutarest_allmeta$Var.Importance,
                          rf.borutarest_impmeta.all1$Var.Importance,
                          rf.borutarest_impmeta.all2$Var.Importance,
                          rf.borutarest_impmeta.late1$Var.Importance,
                          rf.borutarest_impmeta.late2$Var.Importance)
  ...
  #                                         varsnot2norm, TRUE)
  rfN.borutarest                <- train_rf_models(boruta_rest$Base, cv10, 'borutaRest', 
                                                varsnot2norm, TRUE)
  rfN.borutarest_allmeta        <- train_rf_models(allmeta_borutabacrest$Base, cv10, 'borutaRest_Allmeta', 
                                                varsnot2norm, TRUE)
  rfN.borutarest_impmeta.all1   <- train_rf_models(impmeta_all1_borutabacrest$Base, cv10, 'borutaRest_impmeta.all1', 
                                                varsnot2norm, TRUE)
  rfN.borutarest_impmeta.all2   <- train_rf_models(impmeta_all2_borutabacrest$Base, cv10, 'borutaRest_impmeta.all2', 
                                                varsnot2norm, TRUE)
  rfN.borutarest_impmeta.late1 <- train_rf_models(impmeta_late1_borutabacrest$Base, cv10, 'borutaRest_impmeta.late1', 
                                                varsnot2norm, TRUE)
  rfN.borutarest_impmeta.late2 <- train_rf_models(impmeta_late2_borutabacrest$Base, cv10, 'borutaRest_impmeta.late2', 
                                                varsnot2norm, TRUE)
  
  NULL.all.pred.Val <- rbind(rfN.borutarest$Pred.Results.Val,
                             rfN.borutarest_allmeta$Pred.Results.Val,
                             rfN.borutarest_impmeta.all1$Pred.Results.Val,
                             rfN.borutarest_impmeta.all2$Pred.Results.Val,
                             rfN.borutarest_impmeta.late1$Pred.Results.Val,
                             rfN.borutarest_impmeta.late2$Pred.Results.Val)
  
  # rfN.all_Virtaxa$Var.Importance$Dataset = "virtaxa"
  # rfN.imp_Virtaxa$Var.Importance$Dataset = "impvirtaxa"
  # rfN.imp_8vir$Var.Importance$Dataset = "8VirTaxa"
  # rfN.imp8vir_allmeta$Var.Importance$Dataset = "allmaaslinBIN"
  # rfN.imp8vir_impmeta$Var.Importance$Dataset = "allmaaslinLM"
  # rfN.dbo8_MaaslinBIN$Var.Importance$Dataset = "dbo8maaslinBIN"
  # rfN.dbo8_MaaslinLM$Var.Importance$Dataset = "dbo8maaslinLM"
  
  NULL.all.VarImp.list <- list(rfN.borutarest$Var.Importance,
                               rfN.borutarest_allmeta$Var.Importance,
                               rfN.borutarest_impmeta.all1$Var.Importance,
                               rfN.borutarest_impmeta.all2$Var.Importance,
                               rfN.borutarest_impmeta.late1$Var.Importance,
                               rfN.borutarest_impmeta.late2$Var.Importance)
  ...
  # pvar_feature <- plotVarImp(VarImp.summ, 'plus 8VirTaxa', varimp.labels)
  ...
  #             paste("250418_ML_BorutaRest_meta_late_VarImpCombined_DBO", DBO, "_v1.2.csv", sep = ""),
  ...
  write.table(c(DBO,varimp.tests), 
              paste("250418_ML_BorutaRest_meta_late_VarImpTest_DBO", DBO, "_v1.2.csv", sep = ""),
              append = FALSE, col.names = TRUE, row.names = FALSE, sep = ",")
}
