...
setdiff(rownames(t_SM_DF_all),taxmat$Bac_Genus)

rownames(taxmat) <- taxmat$Bac_Genus
...
write.csv(BC_between_case_control_DOL,"BC_phyloseq_bacGenus_between_all_DOL.csv")
