...
data_mec_irep_early2 = filter(data_mec_irep_early, Enterobacter_virMec!="NoVir")


plot_box <- ggplot(data_mec_irep_early2, aes(x=Enterobacter_virMec, y=Enterobacter, fill=Enterobacter_virMec)) +
...
plot_box
ggsave("250423_box_compare_Enterobacter_irep_mec_early.pdf", plot_box, width=2.8, height=5)
