...
data_mec_bactaxa_early2 = filter(data_mec_bactaxa_early, Enterobacter_virMec!="NoVir")


plot_box <- ggplot(data_mec_bactaxa_early2, aes(x=Enterobacter_virMec, y=Enterobacter, fill=Enterobacter_virMec)) +
...
plot_box
ggsave("250423_box_compare_Enterobacter_RA_mec_early.pdf", plot_box3.2, width=2.8, height=5)
