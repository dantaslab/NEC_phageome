...
#===============================================================================
#
# File Name    : s13b_bowtie2_RNA_allphage.sh
# Description  : This script will align reads to a ref using bowtie2
# Usage        : sbatch s13b_bowtie2_RNA_allphage.sh
...
#SBATCH --array=1-2011%20
#SBATCH --output=slurm/bowtie_allphage/R_bowtie2_%A_%a.out
#SBATCH --error=slurm/bowtie_allphage/R_bowtie2_%A_%a.out
...
indir=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/Bowtie_All_phage_RNA/240416_RNA_sample_path_list.txt`
#index is where the output from bowtie2-build is stored
index="${basedir}/Bowtie_All_phage_RNA/BowtieBuild/${ref}/${ref}"
outdir="${basedir}/Bowtie_All_phage_RNA/BowtieMapping/${sample}"
