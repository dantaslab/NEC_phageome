...
indir=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/240416_RNA_sample_path_list.txt`
#index is where the output from bowtie2-build is stored
index="${basedir}/mec/Bowtie_mec_RNA/BowtieBuild/mec_gene"
outdir="${basedir}/mec/Bowtie_mec_RNA/BowtieMapping/${sample}"
