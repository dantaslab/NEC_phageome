...
blastn -query ${indir}/250615_mec_consensus_refine.fna -db ${outdir}/mec_db/mec_nt_db -outfmt '6 std qlen slen' -max_target_seqs 100000 -out ${outdir}/250618_mec_blast_out.tsv -num_threads 2 -perc_identity 0 -qcov_hsp_perc 0
