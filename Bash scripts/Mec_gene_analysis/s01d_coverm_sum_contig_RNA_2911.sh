...
# Usage        : sbatch s01c_coverm_sum_contig_RNA.sh
...
indir="${basedir}/mec/Bowtie_mec_RNA_2911/CoverM_contig_single"
samplelist="${basedir}/250618_mec_RNA_mapping_ref_sample_list_2911.txt"
outfile="${indir}/250618_coverm_sum_mec_RNA_95_contig_2911.tsv"
