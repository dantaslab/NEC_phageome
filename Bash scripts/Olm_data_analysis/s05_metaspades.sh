...
time spades.py --memory ${SLURM_MEM_PER_NODE} --threads ${SLURM_CPUS_PER_TASK} --meta --tmp-dir /tmp/${ID} -1 ${indir}/${ID}_FW_clean.fastq.gz -2 ${indir}/${ID}_RV_clean.fastq.gz -o ${outdir}/${ID}
# --only-assembler 
