...
#SBATCH --mem=1G
#SBATCH --array=1
#SBATCH --output=slurm/catfile/b_catfile_S2_%a.out
#SBATCH --error=slurm/catfile/b_catfile_S2_%a.err

basedir="/scratch/gdlab/kailun/Phageome/NEC_Olm"
indir="/lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA327106"
