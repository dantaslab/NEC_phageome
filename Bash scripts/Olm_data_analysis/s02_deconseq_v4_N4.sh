...
#SBATCH --array=353-600%50
#SBATCH --cpus-per-task=24
#SBATCH --mem=72G
#SBATCH --output=slurm/deconseq/x_deconseq_N4_%a.out
#SBATCH --error=slurm/deconseq/y_deconseq_N4_%a.err
...
outdir="${basedir}/d02_deconseq_N4"
...
set -x
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA396794/${sample}_1.fastq.gz ${indir}
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA396794/${sample}_2.fastq.gz ${indir}
