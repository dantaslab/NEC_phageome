...
#SBATCH --mem=64G
#SBATCH --output=slurm/deconseq/x_deconseq_N1_%a.out
#SBATCH --error=slurm/deconseq/y_deconseq_N1_%a.err
...
outdir="${basedir}/d02_deconseq_N1"
...
set -x
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA294605/${sample}_1.fastq.gz ${indir}
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA294605/${sample}_2.fastq.gz ${indir}
