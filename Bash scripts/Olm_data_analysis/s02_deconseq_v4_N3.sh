...
#SBATCH --array=298-352
#SBATCH --cpus-per-task=24
#SBATCH --mem=72G
#SBATCH --output=slurm/deconseq/x_deconseq_N3_%a.out
#SBATCH --error=slurm/deconseq/y_deconseq_N3_%a.err
...
outdir="${basedir}/d02_deconseq_N3"
...
set -x
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA273761/${sample}_1.fastq.gz ${indir}
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA273761/${sample}_2.fastq.gz ${indir}
