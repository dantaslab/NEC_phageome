...
#SBATCH --mem=1G
#SBATCH --array=1-14
#SBATCH --output=slurm/catfile/x_catfile_%a.out
#SBATCH --error=slurm/catfile/y_catfile_%a.err
...
mkdir -p ${outdir}
sample=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/SRA_Reads/240820_N2_infant_list.txt`
