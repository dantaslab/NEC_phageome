...
#SBATCH --array=870-1158%50
#SBATCH --cpus-per-task=24
#SBATCH --mem=72G
#SBATCH --output=slurm/deconseq/x_deconseq_S2_%a.out
#SBATCH --error=slurm/deconseq/y_deconseq_S2_%a.err
...
outdir="${basedir}/d02_deconseq_S2"
...
set -x
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA376566/${sample}_1.fastq.gz ${indir}
cp /lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA376566/${sample}_2.fastq.gz ${indir}
