...
#SBATCH --mem=1G
#SBATCH --array=1-53%30
#SBATCH --output=slurm/catfile/t_catfile_N5_%a.out
#SBATCH --error=slurm/catfile/t_catfile_N5_%a.err

basedir="/scratch/gdlab/kailun/Phageome/NEC_Olm"
indir="/lts/gdlab/users/current/kailun/Phageome/NEC_Olm_Reads/Rename/PRJNA417343"
outdir="${basedir}/SRA_Reads"

mkdir -p ${outdir}
sample=`sed -n ${SLURM_ARRAY_TASK_ID}p ${basedir}/SRA_Reads/240821_N5_infant_list.txt`
